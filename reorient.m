function [nodes_final, coords_final, coords_final_unit, Temp_Coordinates_Unit, TTA_final, NGA_final, talus_coords_FAO, z_min_xyz_final, MEARY_final, HindFront_final, MDTA_final, TLSA_final, SVA_final] = reorient(Temp_Nodes_Coords,cm_nodes,side_indx,RTs)
...
Temp_Coordinates_origin = Temp_Nodes_Coords(end-19,:); % same as **
Temp_Coordinates_temp = Temp_Nodes_Coords(end-19:end-14,:) - Temp_Coordinates_origin; %% second end should be same as ^^ below and then add 5 for the first end **
...
TTA_final = nodes_coords_final(end-13:end-12,:);
...
HindFront_final = nodes_coords_final(end-6:end-5,:);
MDTA_final = nodes_coords_final(end-4:end-3,:);
TLSA_final = nodes_coords_final(end-2:end-1,:);
SVA_final = nodes_coords_final(end,:);

nodes_coords_final = nodes_coords_final(1:end-14,:); % add 1 to largest 'final' ^^
