function [nodes_final, coords_final, coords_final_unit, Temp_Coordinates_Unit, HindFront_final, MDTA_final, TLSA_final, SVA_final] = reorient(Temp_Nodes_Coords,cm_nodes,side_indx,RTs)
...
Temp_Coordinates_origin = Temp_Nodes_Coords(end-12,:);
Temp_Coordinates_temp = Temp_Nodes_Coords(end-12:end-7,:) - Temp_Coordinates_origin;
...
nodes_coords_final = nodes_coords_final(1:end-7,:);
