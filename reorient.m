function [nodes_final, coords_final, coords_final_unit, Temp_Coordinates_Unit, med_mal_final, NC_nav_final, NC_cub_final, MLCR_final, HAA_final, TTA_final, talus_coords_FAO, z_min_xyz_final, z_min_xyz_MSA_final, MEARY_final, MDTA_final, TLSA_final] = reorient(Temp_Nodes_Coords,cm_nodes,side_indx,RTs)
...
med_mal_final = nodes_coords_final(end-17,:);
