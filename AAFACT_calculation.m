...
for n = 1:length(bone_coord)
    ...
    [Temp_Coordinates, Temp_Nodes, MDTA, TLSA, z_min_xyz, z_min_xyz_MSA, MEARY, TTA, HAA, MLCR, NC_nav, NC_cub, med_mal] = CoordinateSystem(aligned_nodes, bone_indx, bone_coord(n), side_indx);
    ...
    Temp_Nodes_Coords = [Temp_Nodes; Temp_Coordinates; med_mal; NC_nav; NC_cub; MLCR; HAA; TTA; FAO_peak; z_min_xyz; z_min_xyz_MSA; MEARY; MDTA; TLSA];

    %% Reorient and Translate to Original Input Origin and Orientation
    [~, coords_final, coords_final_unit, ~, med_mal_final, NC_nav_final, NC_cub_final, MLCR_final, HAA_final, TTA_final, talus_coords_FAO, z_min_xyz_final, z_min_xyz_MSA_final, MEARY_final, MDTA_final, TLSA_final] = reorient(Temp_Nodes_Coords, cm_nodes, side_indx, RTs);
